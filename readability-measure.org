...
yarr = np.array([976,1440,1702,1893,2057,2166,2270,2357,2451,2521])
xarr = np.array([5000,10000,15000,20000,25000,30000,35000,40000,45000,50000])
...
print "a = %s , b = %s" % (popt[0], popt[1])
      ...
      #+RESULTS:
      : [ 976 1440 1702 1893 2057 2166 2270 2357 2451 2521]
      : <type 'numpy.int64'>
      : a = -4726.54584637 , b = 669.135465666
